...
/// lime_usrp_probe.
class radio_config_limesuiteng_config_validator : public radio_configuration::validator
{
public:
  radio_config_limesuiteng_config_validator();
  virtual ~radio_config_limesuiteng_config_validator();
